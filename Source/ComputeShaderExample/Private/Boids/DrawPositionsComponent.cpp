...
#include "Boids/DrawPositionsComponent.h"
...
void UDrawPositionsComponent::_updateInstanceTransforms()
{
	...
	UBoidShaderComponent* boidsComponent = GetOwner()->FindComponentByClass<UBoidShaderComponent>();

	if (!boidsComponent) return;

	TArray<FVector3f>& positions = boidsComponent->outputPositions;
